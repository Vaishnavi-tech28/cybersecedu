...
const PhishingGame = ({ onComplete }) => {
  ...
  const questions = [
    {
      question: "An email claims to be from your bank, asking you to update your details. What should you do?",
      options: ["Click the link and update", "Ignore the email", "Call the bank using a known number"],
      correct: 2
    },
    {
      question: "You receive an unexpected email with a link to 'claim your prize'. What should you do?",
      options: ["Click the link", "Ignore the email", "Share it with friends to claim your prize"],
      correct: 1
    },
    {
      question: "A pop-up asks you to download software to improve your system performance. What should you do?",
      options: ["Download and install the software", "Ignore or close the pop-up", "Search online for the software name"],
      correct: 1
    },
    {
      question: "You receive an email with an attachment from an unknown sender. What should you do?",
      options: ["Open the attachment", "Delete the email", "Reply and ask for more details"],
      correct: 1
    },
    {
      question: "An email from 'support@paypal' asks you to confirm your identity by clicking a link. What should you do?",
      options: ["Click the link and confirm", "Ignore the email and report it", "Call PayPal to verify the request"],
      correct: 1
    },
    {
      question: "You receive a phone call claiming to be from technical support, asking for remote access to your computer. What should you do?",
      options: ["Allow remote access", "Hang up immediately", "Ask for a callback number"],
      correct: 1
    },
    {
      question: "You receive a suspicious email from a friend asking for money, but their account was hacked. What should you do?",
      options: ["Send the money", "Ignore the request and inform your friend", "Call the friend directly to verify"],
      correct: 2
    },
    {
      question: "You receive a text message claiming to be from a delivery company, asking you to click a link to reschedule your delivery. What should you do?",
      options: ["Click the link and reschedule", "Ignore the message and report it", "Call the delivery company directly to verify"],
      correct: 2
    }
